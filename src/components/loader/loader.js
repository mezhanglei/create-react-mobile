...
class Loader extends React.Component {
    ...
    render() {
        ...
        return (
            <div ref={node => this.box = node} class={styles["loader-fixed"]} style={{ height: height + 'px' }}>
                <span ref={node => this.content = node} class={styles["steps"]} style={{ backgroundColor: bgColor }}></span>
            </div>
        )
    }
}
